      ...
      <div style={{ padding: "16px 24px", margin: "0 auto" }}>
        ...
        {tab === "engagement" && !sel && !eV && (() => {
          const engRows = UPh.map((u) => {
            ...
            return { id: u.id, name: u.n, org: O.find((o) => o.id === u.org)?.n || "", ph: u.ph, day: u.day, tl: ul?.tl || 0, daysSinceLogin, loginRate, avgCat, calls, offers, hasCheckin, lastCheckin, engStatus, engColor, engBg, priGroup: csdPriGroup[u.id] || "", engStart: csdEngStart[u.id] || "", notes: csdNotes[u.id] || "", trk };
          });
